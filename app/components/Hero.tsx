            ...
            <svg className="absolute h-0 w-0" aria-hidden="true">
              <defs>
                <clipPath id="hero-blob" clipPathUnits="objectBoundingBox">
                  <path d="M0.18,0 L0.85,0 C0.92,0,0.96,0.04,0.98,0.1 C1.0,0.2,0.95,0.3,0.97,0.4 C0.99,0.5,1.0,0.58,0.97,0.68 C0.94,0.78,0.98,0.85,0.95,0.9 C0.9,0.94,0.8,0.92,0.7,0.96 C0.6,1.0,0.48,0.95,0.38,0.9 C0.28,0.85,0.18,0.78,0.12,0.68 C0.06,0.60,0.0,0.55,0.03,0.51 C0.06,0.47,0.13,0.43,0.10,0.38 C0.07,0.33,0.0,0.28,0.03,0.23 C0.06,0.18,0.13,0.14,0.10,0.09 C0.07,0.04,0.02,0.02,0.06,0.01 C0.1,0.0,0.14,0,0.18,0" />
                </clipPath>
              </defs>
            </svg>
